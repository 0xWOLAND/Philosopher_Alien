...
liquid_lava_top_img = pygame.image.load('img/Base pack/Tiles/liquidLavaTop.png')
...
class Player():
    ...
    def reset(self, x, y,p):
        ...
        for i in range(12):
            ...
            if i < 10:
                k = '0' + k
            img_path = f'img/Base pack/Player/{self.p}_walk/PNG/{self.p}_walk{k}.png'
...
player = Player(100, HEIGHT - 110, "p1")
world_data = []
